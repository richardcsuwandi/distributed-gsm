...
figName = ['./fig/d2sca/',file_name,'_rho',num2str(rho_init), '_maxiter',int2str(options.max_iter),'.fig'];
...
% Save info
save(['./fig/d2sca/',file_name,'_rho',num2str(rho_init), '_maxiter',int2str(options.max_iter), '.mat'], ...
